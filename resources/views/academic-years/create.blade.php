...
<head>
  ...
  <title>Create Academic Year - Kingsford University</title>
  @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-gray-50 dark:bg-[#18181b]">
  @include('components.sidebar_navigation')
  @include('components.top_navigation', ['title' => 'Create Academic Year'])
  ...
  <div class="lg:ml-64">
    <main class="p-4 lg:p-8">
      ...
      <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Create Academic Year</h2>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Set up a new academic year cycle with its deadlines</p>
      </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                <span class="text-xs text-gray-400 font-normal ml-1">e.g. 2024/2025</span>
              </label>
              <input type="text" name="name" value="{{ old('name') }}" placeholder="2024/2025"
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                <span class="text-xs text-gray-400 font-normal ml-1">e.g. 2024</span>
              </label>
              <input type="number" name="year" value="{{ old('year') }}" placeholder="{{ date('Y') }}" min="2000"
                max="2100"
