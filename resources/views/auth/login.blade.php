<x-guest-layout>
    ...
    @if($errors->has('email') && str_contains($errors->first('email'), 'Account Locked'))
        <div id="lockout-banner" class="mb-6 rounded-lg bg-red-50 dark:bg-red-900/20 p-6 border-2 border-red-500 dark:border-red-700 shadow-lg">
                ...
                <div class="flex-1">
                    ...
                    <div class="bg-red-100 dark:bg-red-900/40 rounded-lg p-4 mb-3">
                        ...
                        <div class="mt-2">
                            <div class="w-full bg-red-200 dark:bg-red-800 rounded-full h-2">
                                <div id="progress-bar" class="bg-red-600 dark:bg-red-500 h-2 rounded-full transition-all duration-1000" style="width: 100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-2 text-sm text-red-700 dark:text-red-300">
                        ...
                        <p>
                            ...
                            <a href="mailto:support@ksf.it.com" class="font-semibold underline hover:text-red-900 dark:hover:text-red-100">
                                support@ksf.it.com
                            </a>
                        </p>
                    </div>
    ...
    <div class="mt-4 text-center">
        <p class="text-xs text-gray-500 dark:text-gray-400">
            ...
            <a href="mailto:support@ksf.it.com" class="text-[#dc2d3d] hover:text-[#b82532] dark:hover:text-[#ff4757] transition-colors">
                support@ksf.it.com
            </a>
        </p>
    </div>
