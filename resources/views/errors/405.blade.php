...
<head>
  ...
  <title>405 - Method Not Allowed| Kingsford University</title>
  ...
  <div class="flex-grow flex items-center justify-center px-6">
    <div class="max-w-4xl w-full text-center">
      ...
      <p class="text-sm md:text-base text-lGray600 dark:text-lGray400 mb-10 leading-relaxed mx-auto">
        Something is broken. Please let us know what you were doing when this error occurred. We will fix it as soon as
