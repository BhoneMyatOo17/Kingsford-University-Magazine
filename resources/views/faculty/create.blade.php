...
<head>
  ...
  <title>Add Faculty - Kingsford University</title>
  @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-gray-50 dark:bg-[#18181b]">
  @include('components.sidebar_navigation')
  @include('components.top_navigation', ['title' => 'Add Faculty'])
    ...
    <main class="p-4 lg:p-8">
      ...
      <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 lg:p-8">
          <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">New Faculty</h2>
          ...
          <form action="{{ route('faculty.store') }}" method="POST" class="space-y-6">
            ...
            <div>
              <label for="code" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Faculty Code
                <span class="text-red-500">*</span></label>
              <input type="text" id="code" name="code" value="{{ old('code') }}" maxlength="10"
            ...
            <div>
              ...
              <textarea id="description" name="description" rows="4"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#dc2d3d] focus:border-transparent @error('description') border-red-500 @enderror"
