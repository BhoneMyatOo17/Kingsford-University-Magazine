...
<head>
  ...
  <title>Add Program - Kingsford University</title>
  @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-gray-50 dark:bg-[#18181b]">
  @include('components.sidebar_navigation')
  @include('components.top_navigation', ['title' => 'Add Program'])
    ...
    <main class="p-4 lg:p-8">
      ...
      <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 lg:p-8">
          <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">New Program</h2>
          ...
          <form action="{{ route('programs.store') }}" method="POST" class="space-y-6">
            ...
            <div>
              ...
              <select id="faculty_id" name="faculty_id" required
                class="w-full px-4 py-2.5 border dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#dc2d3d] @error('faculty_id') border-red-500 @enderror"
            ...
            <div>
              ...
              <textarea id="description" name="description" rows="3"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#dc2d3d]"
                placeholder="Brief program description...">{{ old('description') }}</textarea>
            ...
            <div>
              ...
              <select id="level" name="level" required
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#dc2d3d] @error('level') border-red-500 @enderror"
                style="appearance:none;">
                <option value="">Select level</option>
                <option value="undergraduate" {{ old('level') === 'undergraduate' ? 'selected' : '' }}>Undergraduate
                </option>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                <label for="duration_years"
                  class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Duration (Years) <span
                    class="text-red-500">*</span></label>
                <input type="number" id="duration_years" name="duration_years" value="{{ old('duration_years') }}"
                  min="1" max="10"
                  class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#dc2d3d] @error('duration_years') border-red-500 @enderror"
                  placeholder="e.g. 4">
              ...
              <div>
                ...
                <select id="duration_mode" name="duration_mode"
                  ...
                  style="appearance:none;">
                  <option value="Full-time" {{ old('duration_mode') === 'Full-time' ? 'selected' : '' }}>Full-time
                  </option>
                  <option value="Full-time / Part-time" {{ old('duration_mode') === 'Full-time / Part-time' ? 'selected' : '' }}>Full-time / Part-time</option>
                </select>
                @error('duration_mode')<p class="mt-1 text-sm text-red-500">{{ $message }}</p>@enderror
              </div>
            </div>
            ...
            <div>
              ...
              <input type="number" id="fees_per_semester" name="fees_per_semester"
                value="{{ old('fees_per_semester') }}" step="0.01" min="0"
                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#dc2d3d] @error('fees_per_semester') border-red-500 @enderror"
            ...
            <div class="flex items-center space-x-3">
              ...
              <input type="checkbox" id="is_active" name="is_active" value="1"
                class="w-4 h-4 text-[#dc2d3d] border-gray-300 rounded focus:ring-[#dc2d3d]" {{ old('is_active', true) ? 'checked' : '' }}>
